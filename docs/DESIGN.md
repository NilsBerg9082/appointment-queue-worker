...
> Design notes for **appointment-queue-worker** — a runnable python example that Consume appointment jobs with bounded concurrency and patient-safe operational notification decisions.
...
- **Feature code** — the actual task: appointment-operations-worker.
